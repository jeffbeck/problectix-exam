...
% REGLER
\newcounter{TopicTimeREGLER}
\newcounter{TopicTimeREGLERMin}
% ET
% SCHALTUNG
...
% ETBAUTEILE
\newcounter{TopicTimeETBAUTEILE}
\newcounter{TopicTimeETBAUTEILEMin}
% ZP
% KREISLAUF
...
% Part 1, Abschlussprüfung Teil 1
\newcommand{\Partone}[1]{
\School{Landesinnung Kälte-Klima-Technik}
\Titelu{Abschl.prüf. Teil 1}
\Beruf{Mechatroniker/-in für Kältetechnik}
\Bereich{Kältetechnik}
%
\ifthenelse{\equal{#1}{final}}{\setcounter{ModeFinal}{1}}{\Entwurf{Teil-1-Entwurf}} 
\renewcommand{\ExamWhich}{\textbf{Teil\,1}}
% counters
...
\setcounter{TopicTimeREGLERMin}{0}
% ET
...
\setcounter{TopicTimeETBAUTEILEMin}{0}
% ZP KT
...
\ifthenelse{\equal{#4}{REGLER}}{\addtocounter{TopicTimeREGLER}{#1}\stepcounter{NumberTopicsCounted}}{} 
...
\ifthenelse{\equal{#4}{ETBAUTEILE}}{\addtocounter{TopicTimeETBAUTEILE}{#1}\stepcounter{NumberTopicsCounted}}{} 
...
% \xprojectincludegraphics
\newcommand{\xprojectincludegraphics}[3][]{%
   \ifthenelse{\value{xlsg}=1}{%
      \projectincludegraphics[#1]{#3}%
   }{%
      \projectincludegraphics[#1]{#2}%
   }
}
...
\addtocontents{toc}{\hspace{10mm}Aufgabe \theaufgabennummer: #2 (#3)\dotfill Seite \thepage\par}
