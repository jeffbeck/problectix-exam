...
\newcommand{\projectanhang}[3][]{%
   ...
   %% #1 includgraphicsoptions
   %% #2 Title
   %% #3 included grephics file
...
\ifthenelse{\value{ModeFinal}=1}%
  {\begin{aufgabe}[#1]{#2 \hfill (#3)}}% final
  {\begin{aufgabe}[#1]{#2 \hfill \textcolor{gruen}{#3 --- Draft: #4 #5 #6}}}% draft
%
