...
\newcommand{\projectincludegraphics}[2][]{
    \includegraphics[#1]{../projects/\projectname/#2}
}
...
\ifthenelse{\equal{#5}{WA}}{%
    \ifthenelse{\theLatestMust=2}%
               {}%
               {\pagebreak\section*{Teil 2: Wahlaufgaben (\theTimeTotalWAOK{} Minuten, \theNumberTotalWASelect{} von \theNumberTotalWAOK{} Aufgaben sind zu bearbeiten)}%
                \addtocontents{toc}{\vspace{3mm}\textbf{Teil 2: Wahlaufgaben} (\theTimeTotalWAOK{} Minuten, \theNumberTotalWASelect{} von \theNumberTotalWAOK{} Aufg. bearbeiten)\par}}\setcounter{LatestMust}{2}%
}{}%  
% tableofcontents-header if KT,KL,ET is switched
\ifthenelse{\equal{#4}{KT}}{%
    \ifthenelse{\theLatestCategory=1}%
               {}%
               {\subsection*{Kältetechnik (\theTimeTotalKTOK{} Minuten)}\addtocontents{toc}{\vspace{2mm}\hspace{5mm}\textbf{Kältetechnik (\theTimeTotalKTOK{} Minuten)}\par}}\setcounter{LatestCategory}{1}%
}{}%  
\ifthenelse{\equal{#4}{KL}}{%
    \ifthenelse{\theLatestCategory=2}%
               {}%
               {\subsection*{Klimatechnik (\theTimeTotalKLOK{} Minuten)}\addtocontents{toc}{\vspace{2mm}\hspace{5mm}\textbf{Klimatechnik (\theTimeTotalKLOK{} Minuten)}\par}}\setcounter{LatestCategory}{2}%
}{}% 
\ifthenelse{\equal{#4}{ET}}{%
    \ifthenelse{\theLatestCategory=3}%
               {}%
               {\subsection*{Elektrotechnik (\theTimeTotalETOK{} Minuten)}\addtocontents{toc}{\vspace{2mm}\hspace{5mm}\textbf{Elektrotechnik (\theTimeTotalETOK{} Minuten)}\par}}\setcounter{LatestCategory}{3}%
}{}%  
