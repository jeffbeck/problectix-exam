...
\ifthenelse{\equal{#5}{PF}}{%
    \ifthenelse{\theLatestMust=1}%
               {}%
               {\pagebreak\section*{Teil 1: Projekt-Pflichtaufgaben (Alle Aufgaben sind zu lösen)}\addtocontents{toc}{\vspace{3mm}\textbf{Teil 1: Projekt-Pflichtaufgaben} (Alle Aufgaben sind zu lösen)\par}}\setcounter{LatestMust}{1}%
}{}%
\ifthenelse{\equal{#5}{WA}}{%
    \ifthenelse{\theLatestMust=2}%
               {}%
               {\pagebreak\section*{Teil 2: Wahlaufgaben (\theNumberTotalWASelect{} von \theNumberTotalWAOK{} Aufgaben sind zu bearbeiten)}%
                \addtocontents{toc}{\vspace{3mm}\textbf{Teil 2: Wahlaufgaben} (\theNumberTotalWASelect{} von \theNumberTotalWAOK{} Aufgaben sind zu bearbeiten)\par}}\setcounter{LatestMust}{2}%
}{}%  
