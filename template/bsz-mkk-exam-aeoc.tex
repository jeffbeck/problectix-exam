...
\renewcommand*\contentsname{Aufgabenverzeichnis}
...
\ifthenelse{\equal{#5}{PF}}{%
    \ifthenelse{\theLatestMust=1}%
               {}%
               {\pagebreak\section*{Pflichtaufgaben}\addtocontents{toc}{\textbf{Pflichtaufgaben}\par}}\setcounter{LatestMust}{1}%
}{}%
\ifthenelse{\equal{#5}{WA}}{%
    \ifthenelse{\theLatestMust=2}%
               ...
               {\pagebreak\section*{Wahlaufgaben (\theNumberTotalWASelect{} von \theNumberTotalWAOK{} Aufgaben zu bearbeiten)}%
                \addtocontents{toc}{\textbf{Wahlaufgaben} (\theNumberTotalWASelect{} von \theNumberTotalWAOK{} Aufgaben zu bearbeiten)\par}}\setcounter{LatestMust}{2}%
}{}%  
% tableofcontents-header if KT,KL,ET is switched
\ifthenelse{\equal{#4}{KT}}{%
    \ifthenelse{\theLatestCategory=1}%
               {}%
               {\subsection*{Kältetechnik}\addtocontents{toc}{\hspace{5mm}\textbf{Kältetechnik}\par}}\setcounter{LatestCategory}{1}%
}{}%  
\ifthenelse{\equal{#4}{KL}}{%
    \ifthenelse{\theLatestCategory=2}%
               {}%
               {\subsection*{Klimatechnik}\addtocontents{toc}{\hspace{5mm}\textbf{Klimatechnik}\par}}\setcounter{LatestCategory}{2}%
}{}% 
\ifthenelse{\equal{#4}{ET}}{%
    \ifthenelse{\theLatestCategory=3}%
               {}%
               {\subsection*{Elektrotechnik}\addtocontents{toc}{\hspace{5mm}\textbf{Elektrotechnik}\par}}\setcounter{LatestCategory}{3}%
}{}%  
% tableofcontents of problem
\addtocontents{toc}{\hspace{10mm}Aufgabe \theaufgabennummer: #2 (#3 min)\hfill\thepage\par}
% call aufgabe environment
\ifthenelse{\value{ModeFinal}=1}%
  {\begin{aufgabe}[#1]{#2 \hfill (#3 Minuten)}}%
  {\begin{aufgabe}[#1]{#2 \hfill \textcolor{gruen}{#3 Minuten #4 #5 #6}}}%
%
